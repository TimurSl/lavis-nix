...
5. Установленный модуль остаётся выключенным. Включите его и перезапустите Lavis:
   ...
   `,reboot` перезапускает только процесс Lavis, а не систему. По соображениям безопасности
   он принимается только в новом собственном сообщении в «Сохранённых сообщениях».
